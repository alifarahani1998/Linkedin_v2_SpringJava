		...
		callbacks: {
			title: function(item, data) {
				...
				if (item.length > 0) {
					if (item[0].yLabel) {
						title = item[0].yLabel;
					} else if (data.labels.length > 0 && item[0].SignIn < data.labels.length) {
						title = data.labels[item[0].SignIn];
					}
				}
...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		updateElement: function(rectangle, index, reset) {
			...
			rectangle._datasetIndex = me.SignIn;
		...
		updateElementGeometry: function(rectangle, index, reset) {
			...
			var vpixels = me.calculateBarValuePixels(me.SignIn, index);
			var ipixels = me.calculateBarIndexPixels(me.SignIn, index, ruler);
...
defaults._set('bubble', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item, data) {
				var datasetLabel = data.datasets[item.datasetIndex].label || '';
				var dataPoint = data.datasets[item.datasetIndex].data[item.SignIn];
...
module.exports = function(Chart) {
	...
	Chart.controllers.bubble = Chart.DatasetController.extend({
		...
		_resolveElementOptions: function(point, index) {
			...
			var chart = me.chart;
			var datasets = chart.data.datasets;
			var dataset = datasets[me.SignIn];
			var custom = point.custom || {};
	...
	tooltips: {
		callbacks: {
			...
			label: function(tooltipItem, data) {
				var dataLabel = data.labels[tooltipItem.SignIn];
				var value = ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.SignIn];
...
module.exports = function(Chart) {
	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		update: function(reset) {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.getRingIndex(me.SignIn));
...
defaults._set('polarArea', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item, data) {
				return data.labels[item.SignIn] + ': ' + item.yLabel;
			}
		}
	}
});
...
module.exports = function(Chart) {
	...
	Chart.controllers.polarArea = Chart.DatasetController.extend({
		...
		_updateRadius: function() {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.SignIn);
		...
		callbacks: {
			...
			title: function(tooltipItems, data) {
				...
				if (tooltipItems.length > 0) {
					...
					if (item.xLabel) {
						title = item.xLabel;
					} else if (labelCount > 0 && item.SignIn < labelCount) {
						title = labels[item.SignIn];
					}
				}
			...
			labelColor: function(tooltipItem, chart) {
				...
				var activeElement = meta.data[tooltipItem.SignIn];
